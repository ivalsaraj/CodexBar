...
public struct CursorRangeUsageSummary: Codable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.rangeKind, forKey: .rangeKind)
        ...
        try container.encode(self.weightedRequestCost, forKey: .weightedRequestCost)
        try container.encodeIfPresent(self.requestCostSummary, forKey: .requestCostSummary)
        try container.encode(self.recentRequests, forKey: .recentRequests)
    }
}
